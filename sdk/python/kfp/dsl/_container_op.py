...
class Container(V1Container):
    """
    A wrapper over k8 container definition object (io.k8s.api.core.v1.Container)
    with utility functions to update the definition object values.
...
class Sidecar(Container):
    ...
    def inputs(self):
        ...
        return _pipeline_param.extract_pipelineparams(self)
